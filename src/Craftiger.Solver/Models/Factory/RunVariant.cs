...
/// <summary>One way to run a recipe: a block at an overclock with its effective duration, energy per run and parallels; steam variants draw SteamPerRun liters of SteamItem instead of EU.</summary>
