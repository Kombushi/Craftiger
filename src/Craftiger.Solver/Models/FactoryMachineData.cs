...
/// <summary>Machine blocks per map, keyed by the map name recipes carry, plus the coil
/// ladder for tier-scaled bonuses. A map without an entry runs on an anonymous block at the
/// garage tier — the pre-machine-props behavior, flagged per line.</summary>
