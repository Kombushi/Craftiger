...
/// producer of the item. <paramref name="MobFarms"/> adds the mob-drop seeds to the
/// auto-infinite set. <paramref name="TimeLimitSeconds"/> bounds the whole solve; zero
